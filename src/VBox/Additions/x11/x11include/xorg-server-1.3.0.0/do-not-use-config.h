...
#define BASE_FONT_PATH "/local/xorg/lib/X11/fonts"
...
/* Default font path */
#define COMPILEDDEFAULTFONTPATH "/local/xorg/lib/X11/fonts/misc/,/local/xorg/lib/X11/fonts/TTF/,/local/xorg/lib/X11/fonts/OTF,/local/xorg/lib/X11/fonts/Type1/,/local/xorg/lib/X11/fonts/100dpi/,/local/xorg/lib/X11/fonts/75dpi/"
...
#define DEFAULT_LIBRARY_PATH "/local/xorg/lib"

/* Default log location */
#define DEFAULT_LOGPREFIX "/local/xorg/var/log/Xorg."

/* Default module search path */
#define DEFAULT_MODULE_PATH "/local/xorg/lib/xorg/modules"
...
#define DRI_DRIVER_PATH "/local/xorg/lib/dri"
...
#define PACKAGE_STRING "xorg-server 1.3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xorg-server"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.3.0.0"
...
/* Default RGB path */
#define RGB_DB "/local/xorg/share/X11/rgb"
...
/* Path to XKB data */
#define XKB_BASE_DIRECTORY "/local/xorg/share/X11/xkb"

/* Path to XKB bin dir */
#define XKB_BIN_DIRECTORY "/local/xorg/bin"
...
#define XKM_OUTPUT_DIR "/local/xorg/share/X11/xkb/compiled/"

/* Building Xorg server */
#define XORGSERVER 1

/* Vendor release */
#define XORG_DATE "19 April 2007"

/* Vendor man version */
#define XORG_MAN_VERSION "Version 1.3"

/* Vendor release */
#define XORG_RELEASE "Release 1.3"

/* Building Xorg server */
#define XORG_SERVER 1

/* Current Xorg version */
#define XORG_VERSION_CURRENT (((1) * 10000000) + ((3) * 100000) + ((0) * 1000) + 0)
